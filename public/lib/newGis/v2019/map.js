...
;(function() {
  ...
  x.D.Sb = function(a, b) {
    ...
    if (a === p) return a
    for (
      var c = a.className.split(/\s+/), d = b.split(/\s+/), e, f = d.length, g, i = 0;
      i < f;
      ++i
    ) {
      g = 0
  ...
  x.D.Ua = function(a, b) {
    ...
    if (a === p) return a
    for (
      var c = b.split(/\s+/), d = a.className, e = ' ' + d + ' ', f = 0, g = c.length;
      f < g;
      f++
    )
  ...
  x.SK = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 < Math.abs((this.yk ? a.touches[0].clientX : a.clientX) - this.du) ||
          10 < Math.abs(c - this.eu)
        )
          this.ph = o
      },
      end: function(a) {
  ...
  x.extend(La.prototype, {
    ...
    Dg: function(a, b) {
      if (
        Xa(a) &&
        (this.Su(), this.dispatchEvent(new O('onzoomstart')), (a = this.Tn(a).zoom), a !== this.Oa)
      ) {
        this.Lc = this.Oa
        this.Oa = a
        var c
    ...
    Bb: function() {
      return this.ns && this.ns instanceof N
        ? new N(this.ns.width, this.ns.height)
        : new N(this.Va.clientWidth, this.Va.clientHeight)
    },
    ye: function(a) {
      a && a instanceof N
        ? ((this.ns = a),
    ...
    Qt: function(a) {
      ...
      if (a) {
        ...
        Ra(5050, c)
        a.style &&
          (c = b.K.cm[a.style] ? b.K.cm[a.style].backColor : b.K.cm.normal.backColor) &&
  ...
  x.da.nf
    ? (x.extend(E, {
      ...
      x.platform.lM && (E.fontFamily = 'arial,simsun,sans-serif'))
    : x.da.cC || x.da.gF
    ? x.extend(E, {
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Qb(b.Lm, function(b, g) {
              RegExp(g.filter).test(c.getAttribute('filter')) &&
                g.lm.call(c, a, c.getAttribute('filter'))
            })
            c = c.parentNode
          }
        },
        ...
        (c.alog('cus.on', 'time', function(a) {
          ...
          if ('[object Object]' === a.toString()) {
            for (var g in a)
              'page' == g
                ? (b.page = a[g])
                : ((e = parseInt(a[g])), 0 < e && /^z_/.test(g) && ((d = o), (b[g] = e)))
      ...
      if (t && t.yh && k() < t.yh) {
        var A = ['Moz', 'O', 'ms', 'Webkit'],
          ...
          te = function() {
            ...
            return (
              !!b.createElementNS && !!b.createElementNS('http://www.w3.org/2000/svg', 'svg').H1
            )
          },
          gi = function() {
            return !!a.D0
          ...
          ni = function() {
            return (
              ...
              ('Notification' in a && 'permission' in a.sP && 'requestPermission' in a.sP)
            )
          },
          oi = function() {
            for (
              var b = ['webkit', 'moz', 'o', 'ms'], c = a.requestAnimationFrame, e = 0;
              e < b.length && !c;
              ++e
            )
  ...
  x.object.extend(I, {
    ...
    ib: function(a) {
      this.Pd.rl[a] ||
        ((this.Pd.rl[a] = {}), (this.Pd.rl[a].Bd = this.Fj.nG), (this.Pd.rl[a].Ou = []))
      return this.Pd.rl[a]
    },
    remove: function(a) {
      delete this.ib(a)
  ...
  x.extend(Tb.prototype, {
    ...
    remove: function() {
      this.C = p
      this.B &&
        (this.B.parentNode && this.B.parentNode.removeChild(this.B), (this.B = this.B.hr = p))
    },
    Aa: function() {
  ...
  x.object.extend(dc.prototype, {
    ...
    bF: function(a) {
      if (this.Ce[a]) {
        for (var b = 0, c = this.ya.length; b < c; b++)
          this.ya[b] &&
            'divider' == this.ya[b].Mb && this.ya[b].Nj == a &&
  ...
  x.object.extend(eb.prototype, {
    ...
    of: u('ul'),
    GV: function(a) {
      return !(a instanceof eb) || this.xj() || a.xj()
        ? q
        : a.Le > this.Le && a.Ge < this.Ge && a.Ke > this.Ke && a.Fe < this.Fe
    },
    Ka: function() {
    ...
    gt: function(a) {
      if (
        !(a instanceof eb) ||
        Math.max(a.Le, a.Ge) < Math.min(this.Le, this.Ge) ||
        Math.min(a.Le, a.Ge) > Math.max(this.Le, this.Ge) ||
        Math.max(a.Ke, a.Fe) < Math.min(this.Ke, this.Fe) ||
        Math.min(a.Ke, a.Fe) > Math.max(this.Ke, this.Fe)
      )
        return p
    ...
    cs: function(a) {
      return !(a instanceof H) || this.xj()
        ? q
        : a.lng >= this.Le && a.lng <= this.Ge && a.lat >= this.Ke && a.lat <= this.Fe
    },
    extend: function(a) {
      if (a instanceof H) {
        var b = a.lng,
    ...
    JF: function() {
      return this.xj()
        ? new H(0, 0)
        : new H(Math.abs(this.Ge - this.Le), Math.abs(this.Fe - this.Ke))
    }
  })
  ...
  x.extend(R, {
    ...
    Re: function(a, b, c, d) {
      return (
        this.jP * Math.acos(Math.sin(c) * Math.sin(d) + Math.cos(c) * Math.cos(d) * Math.cos(b - a))
      )
    },
    Sk: function(a) {
  ...
  z.Ue(function(a) {
    ...
    a.addEventListener('clearoverlays', function() {
      ...
      for (var d = b.Be.length; a < d; a++)
        b.Be[a].enableMassClear !== q &&
          (b.Be[a].remove(), (b.Be[a] = p), b.Be.splice(a, 1), a--, d--)
    })
  ...
  oc.OE = [0.09, 0.005, 1.0e-4, 1.0e-5]
  ...
  x.extend(pc.prototype, {
    ...
    draw: function() {
      ...
      this.z.za = new N(
        -Math.round(this.z.width / 2) - Math.round(this.z.Qx),
        -Math.round(this.z.height / 2) - Math.round(this.z.Qx)
      )
  ...
  fb.prototype.Nb = function(a) {
    this.map &&
      (this.map.Wc(), (a.Qa = o), (this.map.R.ll = a), (a.ab = this), x.lang.Ca.call(a, a.ba))
  }
  fb.prototype.Wc = function() {
    this.map &&
      this.map.R.ll &&
      ((this.map.R.ll.Qa = q), x.lang.Rw(this.map.R.ll.ba), (this.map.R.ll = p))
  }
  ...
  x.extend(Gc.prototype, {
    ...
    k_: function(a, b, c, d) {
      ...
      k && k.Hb
        ...
        : (k = this.dj[g]) && k.Hb
        ? (c.Qb.insertBefore(k.Hb, c.Qb.lastChild),
          (this.vg[g] = k),
          vb(k.Hb, b),
          d &&
            ((d = new Q(a[0], a[1])),
    ...
    VD: function(a, b) {
      return this.map.pa() === Pa
        ? 'TILE-' + b.ba + '-' + this.map.Dw + '-' + a[0] + '-' + a[1] + '-' + a[2]
    ...
    oV: function(a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          d = Math.floor(this.iI / c),
          e = Math.floor(this.jI / c),
          c = Math.floor(this.MA / c),
          f = [],
          g = 0;
        g < a.length;
        g++
        ...
        if (k >= d) {
          ...
          k <= e &&
            ((k -= c), (l = 'id_' + k + '_' + i + '_' + b), a[l] || ((a[l] = o), f.push([k, i])))
      }
      ...
      for (var g = 0; g < c; g++) {
        ...
        if (!i.$H && !((i.mp && !this.map.Vb()) || (i.jM && this.map.Vb()))) {
          ...
          for (A in C) {
            var D = C[A],
              B = D.info
            ;(B[2] != f || (B[2] == f && (n > B[0] || v <= B[0] || l > B[1] || e <= B[1]))) &&
              this.Ex(D)
          }
          C = -d.offsetX + d.width / 2
          D = -d.offsetY + d.height / 2
          i.Qb &&
            ((i.Qb.style.left = Math.ceil(w + C) - t[0] + 'px'),
  ...
  x.extend(Hc.prototype, {
    ...
    remove: function() {
      this.Qb &&
        this.Qb.parentNode &&
        ((this.Qb.innerHTML = ''), this.Qb.parentNode.removeChild(this.Qb))
      delete this.Qb
    },
    mt: u('R_'),
    getTilesUrl: function(a, b) {
      ...
      var d = ''
      this.rh.tileUrlTemplate &&
        ((d = this.rh.tileUrlTemplate.replace(/\{X\}/, c)),
        (d = d.replace(/\{Y\}/, a.y)),
        (d = d.replace(/\{Z\}/, b)))
      return d
    },
  ...
  Zc.getTilesUrl = function(a, b, c) {
    ...
    //普通地图
    var tdir =
      offmapcfg.tiles_dir.length > 0
        ? offmapcfg.tiles_dir
        : offmapcfg.home + 'tiles' /*guoguo 使用本地的瓦片 */
  ...
  $c.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.oO[Math.abs(c + d) % this.oO.length] +
      this.map.Wb +
      '/' +
      this.map.Dw +
      '/3/lv' +
  ...
  ad.getTilesUrl = function(a, b) {
    var c = a.x,
      d = a.y
    var tdir =
      offmapcfg.tiles_hybrid.length > 0
        ? offmapcfg.tiles_hybrid
        : offmapcfg.home + 'tiles_hybrid' /*guoguo 使用本地卫星的瓦片 */
  ...
  x.extend(ud.prototype, {
    ...
    QV: function() {
      ...
      this.page > this.Jd - this.Vf &&
        this.page >= this.Vf &&
        ((d = this.Jd - this.Vf + 1), (b = this.Jd))
      for (e = d; e <= b; e++)
        0 < e &&
          (e == this.page
  ...
  x.extend(bb.prototype, {
    ...
    Kp: function(a) {
      this.k.Ek =
        'number' == typeof a && !isNaN(a) ? (1 > a ? bb.$p : a > bb.zn ? bb.$p : a) : bb.$p
    },
    pf: function() {
      return this.k.Ek
    },
  ...
  function Oa(a, b) {
    function c() {
      e.k.visible
        ? ('inter' === e.Ie && e.k.haveBreakId && e.k.indoorExitControl === o
            ? x.D.show(e.tA)
            : x.D.U(e.tA),
          this.k.closeControl && this.zf && this.C && this.C.Na() === this.B
            ? x.D.show(e.zf)
            : x.D.U(e.zf),
          this.k.forceCloseControl && x.D.show(e.zf))
        : (x.D.U(e.zf), x.D.U(e.tA))
    }
  ...
  function Na(a) {
    ...
    if (
      ...
      (x.platform.Fm && -1 == navigator.userAgent.indexOf('Android 5'))
    )
      return (Wd = q)
    var a = document.createElement('canvas'),
      b = p
          ...
          if (a.id != b.Vv) {
            ...
            if (b.pl) {
              ...
              c =
                ...
                Math.cos(Ob(c)) * Math.cos(Ob(i)) * Math.sin(f / 2) * Math.sin(f / 2)
    ...
    jp: function(a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) d()
        ...
        this.co.bC(b, function(b) {
          b
            ? e.co.pj(c.lngLat, be.nP, function(b) {
                if (b && b.id) {
                  var f = b.id,
                    k = b.th,
                    b = b.uh,
  ...
  function Ne(a, b) {
    ...
    c.options.Tk
      ? (c.Ob.style[ne] = 'translate(' + c.x + 'px,' + c.y + 'px)' + Me)
      : (c.Ob.style.cssText += ';position:absolute;top:' + c.y + 'px;left:' + c.x + 'px')
  ...
  Ne.prototype = {
    ...
    rQ: function() {
      !this.ph &&
        !this.Wk &&
          !(
            this.Vl ||
            (this.vy == this.Ob.offsetWidth * this.scale &&
              this.Fp == this.Ob.offsetHeight * this.scale)
          ) &&
        this.refresh()
    },
    Fv: function(a) {
      ...
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ...
            this.options.iF
              ? (b.className = this.options.iF + a.toUpperCase())
              : (b.style.cssText =
    ...
    wr: function(a, b) {
      this.Wk ||
        ...
        this.options.Tk
          ? (this.Ob.style[ne] =
              'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Me)
          : ((a = de.round(a)),
            (b = de.round(b)),
    ...
    nB: function(a, b) {
      ...
      this[a + 'Scrollbar'] &&
        ...
        0 > c
          ? (this.options.pD ||
              ((c = this[a + 'ScrollbarIndicatorSize'] + de.round(3 * c)),
              8 > c && (c = 8),
          ...
          : c > this[a + 'ScrollbarMaxScroll'] &&
            (this.options.pD
              ...
              : ((c =
                  ...
                  de.round(3 * (c - this[a + 'ScrollbarMaxScroll']))),
                8 > c && (c = 8),
                (this[a + 'ScrollbarIndicator'].style['h' == a ? 'width' : 'height'] = c + 'px'),
        ...
        (this[a + 'ScrollbarIndicator'].style[ne] =
          'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + Me))
    },
    CQ: function(a) {
      ...
      if ('select' != b && 'input' != b && 'textarea' != b)
        return (
          a.stopImmediatePropagation ? a.stopImmediatePropagation() : (a.jZ = o),
          a.stopPropagation(),
          a.preventDefault(),
          (this.ax = this.LB = p),
          q
    ...
    Ov: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          Be && 1 < a.touches.length &&
          ((d = de.abs(a.touches[0].pageX - a.touches[1].pageX)),
        ...
        if (
          this.options.Vx &&
          (this.options.Tk
            ? ((c = getComputedStyle(this.Ob, p)
                [ne].replace(/[^0-9\-.,]/g, '')
                .split(',')),
              (d = +(c[12] || c[4])),
              (c = +(c[13] || c[5])))
            : ((d = +getComputedStyle(this.Ob, p).left.replace(/[^0-9-]/g, '')),
      ...
      if (this.options.zoom && Be && 1 < a.touches.length)
        (e = de.abs(a.touches[0].pageX - a.touches[1].pageX)),
          ...
          b < this.options.Vk
            ...
            : b > this.options.Wp && (b = 2 * this.options.Wp * Math.pow(0.5, this.options.Wp / b)),
        ...
        ;(6 > this.fw && 6 > this.gw) ||
          (this.options.BE &&
            (this.fw > this.gw + 5
              ? ((f = this.y), (d = 0))
              : this.gw > this.fw + 5 && ((e = this.x), (c = 0))),
          (this.ph = o),
          this.wr(e, f),
          (this.FC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.GC = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime &&
            ((this.startTime = g), (this.du = this.x), (this.eu = this.y)),
      ...
      if (!(Be && 0 !== a.touches.length)) {
        ...
        if (b.Wk)
          ...
          if (b.ph) {
            ...
            f.Ba || g.Ba
              ? ((c = de.max(de.max(f.time, g.time), 10)),
                b.options.au &&
                  ((f = d - b.hw),
                  (g = e - b.jw),
                  de.abs(f) < b.options.Fy && de.abs(g) < b.options.Fy
                    ? b.scrollTo(b.hw, b.jw, 200)
                    : ((f = b.fJ(d, e)), (d = f.x), (e = f.y), (c = de.max(f.time, c)))),
                b.scrollTo(de.round(d), de.round(e), c))
              : b.options.au
              ? ((f = d - b.hw),
                (g = e - b.jw),
                de.abs(f) < b.options.Fy && de.abs(g) < b.options.Fy
    ...
    fo: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.ph && ((this.ph = q), this.options.ay && this.options.ay.call(this)),
          this.mi &&
            this.options.Dx &&
            ('webkit' == fe && (this.ML.style[xe] = '300ms'), (this.ML.style.opacity = '0')),
      ...
      a.Vl ||
        (a.Aj.length
          ? ((e = a.Aj.shift()),
            ...
            (a.ph = o),
            a.options.Ai)
            ? (a.oJ(e.time), a.wr(e.x, e.y), (a.Vl = q), e.time ? a.ca(Je) : a.fo(0))
            : ((g = function() {
                var i = Date.now(),
                  k
                if (i >= d + e.time) {
    ...
    refresh: function() {
      ...
      if ('string' == typeof this.options.au) {
        ...
        this.fe % this.su &&
          (this.Se[this.Se.length] =
            this.fe - this.Se[this.Se.length - 1] + this.Se[this.Se.length - 1])
        b = d = 0
        for (this.uf = []; d >= this.nd; ) (this.uf[b] = d), (d -= this.vn), b++
        this.nd % this.vn &&
          (this.uf[this.uf.length] =
            this.nd - this.uf[this.uf.length - 1] + this.uf[this.uf.length - 1])
      }
      this.Fv('h')
      this.Fv('v')
    ...
    scrollTo: function(a, b, c, d) {
      ...
      for (b = e.length; a < b; a++)
        e[a].lZ && ((e[a].x = this.x - e[a].x), (e[a].y = this.y - e[a].y)),
          this.Aj.push({
            x: e[a].x,
            y: e[a].y,
            time: e[a].time || 0
  ...
  z.Rm(function(a) {
    ...
    a.addEventListener('position_changed', function() {
      a.k.visible &&
        a.k.albumsControl === o &&
        (b ? b.ny(a.Zb()) : ((b = new Oe(a.k.albumsControlOptions)), b.ra(a)))
    })
    a.addEventListener('albums_visible_changed', function() {
      a.k.albumsControl === o
        ? (b ? b.ny(a.Zb()) : ((b = new Oe(a.k.albumsControlOptions)), b.ra(a)), b.show())
        : b.U()
    })
  ...
  x.extend(Oe.prototype, {
    Kk: function(a) {
      ...
      this.qc(this.k.anchor)
      this.B.style.width =
        isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth + 'px'
    ...
    OV: function() {
      if (this.Ki) (a = this.jL(this.Ni)), (this.qQ.innerHTML = a)
        ...
        var a = M('div'),
          ...
          g = M('span'),
          i = [
            'background:url(' + E.qa + 'panorama/catlog_icon.png) no-repeat;',
    ...
    PV: function() {
      if (this.Ni && !(0 >= this.Ni.length)) {
        ...
        this.Ki &&
          (this.Ki.style.left = parseInt(this.Ki.style.left, 10) + this.eg.width + 8 + 'px')
        var b = this
    ...
    Dl: function(a) {
      ...
      this.k.showCatalog &&
        (0 < this.Ni.length
          ? (Va() ? this.OV() : this.RV(), (this.Oc.offsetLeft = 60))
          : (this.Hs &&
              (this.B.removeChild(this.Hs), (this.Hs = p), (this.Oc.fg.style.left = '0px')),
            this.Ki && (this.B.removeChild(this.Ki), (this.Ki = p)),
            (this.Oc.offsetLeft = 0)))
      var b = this.fX(a)
      Va() &&
        this.Ni && 0 < this.Ni.length && this.k.showExit && this.Wz &&
        ((this.Oc.offsetLeft += this.eg.width + 8),
    ...
    fX: function(a) {
      for (var b, c, d, e, f = [], g = this.eg.height, i = this.eg.width, k = 0; k < a.length; k++)
        (b = a[k]),
          ...
          3 === recoType
            ? Va()
              ? ((this.Wz = b), (this.zW = d), a.splice(k, 1), k--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  k +
                  '"><img style="width:' +
  ...
  Se.prototype = {
    ...
    refresh: function() {
      ...
      this.fg &&
        (this.fg.children[0].style.marginTop = this.Cr.children[0].style.marginTop =
    ...
    scrollTo: function(a) {
      a =
        a < this.Sg.offsetLeft
          ? Math.ceil((a - this.Ei - this.ao) / this.Kr) * this.Kr + this.ao + this.Ei - 8
          : Math.ceil((a - this.Ei) / this.Kr) * this.Kr + this.Ei
