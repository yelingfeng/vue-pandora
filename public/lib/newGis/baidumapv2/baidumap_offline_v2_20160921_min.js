...
;(function() {
  ...
  ;/msie (\d+\.\d)/i.test(navigator.userAgent) &&
    (x.ea.la = x.la = document.documentMode || +RegExp.$1)
  var ia = {
  ...
  8 > x.ea.la
    ? ((ia['for'] = 'htmlFor'), (ia['class'] = 'className'))
    : ((ia.htmlFor = 'for'), (ia.className = 'class'))
  x.D.AG = ia
  ...
  ;/(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(ja) &&
    !/chrome/i.test(ja) &&
    (x.ea.HN = +(RegExp.$1 || RegExp.$2))
  ...
  x.SK = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 < Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.au) ||
          10 < Math.abs(c - this.bu)
        ) {
          this.rh = o
        }
      },
  ...
  x.extend(Ka.prototype, {
    ...
    Fg: function(a, b) {
      if (
        Va(a) &&
        (this.Su(), this.dispatchEvent(new N('onzoomstart')), (a = this.Vn(a).zoom), a !== this.Ka)
      ) {
        this.Cc = this.Ka
        this.Ka = a
        var c
    ...
    Nt: function(a) {
      ...
      if (a) {
        ...
        Pa(5050, c)
        a.style &&
          (c = b.K.dm[a.style] ? b.K.dm[a.style].backColor : b.K.dm.normal.backColor) &&
    ...
    XL: function(a) {
      a
        ? (this.js && this.js.xf === a) ||
          (this.zh(this.js), (this.js = new nb({ geotableId: a })), this.Yg(this.js))
        : this.zh(this.js)
    },
    Ub: function() {
  ...
  z.Hc =
    z.url.proto +
    ('2' == z.ou ? z.url.domain.main_domain_nocdn.other : z.url.domain.main_domain_nocdn.baidu) +
    '/'
  z.ma = bdmapcfg.home
  ...
  function sb(a) {
    var b = { duration: 1000, Ic: 30, Io: 0, hc: tb.sM, yt: s() }
    this.Zf = []
    if (a) {
      for (var c in a) {
        b[c] = a[c]
  ...
  x.ea.rg
    ? (x.extend(F, {
      ...
      x.platform.kM && (F.fontFamily = 'arial,simsun,sans-serif'))
    : x.ea.eC || x.ea.HN
    ? x.extend(F, {
    ...
    $a = {
      Fi: {
        iE: function(a) {
          ...
          k = { p: a.kZ, mnt: i, b: 50 }
          window.localStorage &&
            window.JSON && window.addEventListener &&
            ((e = d.get(o)),
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Pb(b.Mm, function(b, g) {
              RegExp(g.filter).test(c.getAttribute('filter')) &&
                g.mm.call(c, a, c.getAttribute('filter'))
            })
            c = c.parentNode
          }
        },
      ...
      ;(function(a, b, c) {
        ...
        if (!C || !C.Ho) {
          ...
          w.prototype.set = function(a, b) {
            if ('string' == typeof a) {
              'protocolParameter' == a && (b = v({ ky: p, ZE: p }, b)), (this.Hs[a] = b)
            } else {
              if ('object' == typeof a) {
                for (var c in a) {
                  this.set(c, a[c])
  ...
  x.object.extend(I, {
    ...
    C3: {},
    gG: { VP: z.ma + 'getmodules?v=2.0&t=20140707', xU: 5000 },
    DC: q,
    Nd: { rl: {}, En: [], Pv: [] },
    load: function(a, b, c) {
      var d = this.hb(a)
    ...
    hb: function(a) {
      this.Nd.rl[a] ||
        ((this.Nd.rl[a] = {}), (this.Nd.rl[a].Bd = this.Fj.nG), (this.Nd.rl[a].Pu = []))
      return this.Nd.rl[a]
    },
    remove: function(a) {
      delete this.hb(a)
  ...
  x.extend(Sb.prototype, {
    ...
    remove: function() {
      this.C = p
      this.B &&
        (this.B.parentNode && this.B.parentNode.removeChild(this.B), (this.B = this.B.ir = p))
    },
    za: function() {
  ...
  function kb(a) {
    ...
    this.qc(a.anchor)
    this.Zh = {
      metric: { name: 'metric', lK: 1, WL: 1000, BO: '\u7c73', CO: '\u516c\u91cc' },
  ...
  x.object.extend(cc.prototype, {
    ...
    eF: function(a) {
      if (this.Ae[a]) {
        for (var b = 0, c = this.xa.length; b < c; b++) {
          this.xa[b] &&
            'divider' == this.xa[b].Lb && this.xa[b].Oj == a &&
  ...
  x.object.extend(fb.prototype, {
    ...
    kf: t('ul'),
    GV: function(a) {
      return !(a instanceof fb) || this.yj() || a.yj()
        ? q
        : a.Je > this.Je && a.Ee < this.Ee && a.Ie > this.Ie && a.De < this.De
    },
    Ja: function() {
    ...
    ft: function(a) {
      if (
        !(a instanceof fb) ||
        Math.max(a.Je, a.Ee) < Math.min(this.Je, this.Ee) ||
        Math.min(a.Je, a.Ee) > Math.max(this.Je, this.Ee) ||
        Math.max(a.Ie, a.De) < Math.min(this.Ie, this.De) ||
        Math.min(a.Ie, a.De) > Math.max(this.Ie, this.De)
      ) {
        return p
      }
    ...
    bs: function(a) {
      return !(a instanceof H) || this.yj()
        ? q
        : a.lng >= this.Je && a.lng <= this.Ee && a.lat >= this.Ie && a.lat <= this.De
    },
    extend: function(a) {
      if (a instanceof H) {
        var b = a.lng,
    ...
    KF: function() {
      return this.yj()
        ? new H(0, 0)
        : new H(Math.abs(this.Ee - this.Je), Math.abs(this.De - this.Ie))
    }
  })
  function H(a, b) {
  ...
  x.extend(R, {
    ...
    Pe: function(a, b, c, d) {
      return (
        this.iP * Math.acos(Math.sin(c) * Math.sin(d) + Math.cos(c) * Math.cos(d) * Math.cos(b - a))
      )
    },
    Tk: function(a) {
  ...
  x.extend(mc.prototype, {
    ...
    draw: function() {
      ...
      this.z.ya = new L(
        -Math.round(this.z.width / 2) - Math.round(this.z.Px),
        -Math.round(this.z.height / 2) - Math.round(this.z.Px)
      )
  ...
  gb.prototype.Mb = function(a) {
    this.map &&
      (this.map.Xc(), (a.Pa = o), (this.map.R.ll = a), (a.$a = this), x.lang.Ba.call(a, a.ba))
  }
  gb.prototype.Xc = function() {
    this.map &&
      this.map.R.ll &&
      ((this.map.R.ll.Pa = q), x.lang.Rw(this.map.R.ll.ba), (this.map.R.ll = p))
  }
  function rc(a, b) {
    gb.call(this)
    this.content = a
  ...
  function wc(a, b) {
    ...
    vc() &&
      ...
      (c.da = { ia: a }),
      (c.z = { shape: b.shape || tc, size: b.size || uc, color: b.color || '#fa937e', ii: o }),
      (this.gB = []),
      (this.ke = []),
  ...
  x.extend(zc.prototype, {
    ...
    hn: function(a, b) {
      this.ro[a] &&
        ...
        0 == a &&
          !this.ia[0].mb(this.ia[this.ia.length - 1]) &&
  ...
  x.extend(Dc.prototype, {
    ...
    XD: function(a, b) {
      return this.map.oa() === Oa
        ? 'TILE-' + b.ba + '-' + this.map.Cw + '-' + a[0] + '-' + a[1] + '-' + a[2]
    ...
    oV: function(a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          d = Math.floor(this.hI / c),
          e = Math.floor(this.iI / c),
          c = Math.floor(this.NA / c),
          f = [],
          g = 0;
        g < a.length;
        g++
  ...
  x.extend(Ec.prototype, {
    ...
    getTilesUrl: function(a, b) {
      ...
      this.uh.tileUrlTemplate &&
        ((d = this.uh.tileUrlTemplate.replace(/\{X\}/, c)),
        (d = d.replace(/\{Y\}/, a.y)),
        (d = d.replace(/\{Z\}/, b)))
      return d
    },
  ...
  Wc.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.lO[Math.abs(c + d) % this.lO.length] +
      this.map.Vb +
      '/' +
      this.map.Cw +
      '/3/lv' +
  ...
  x.extend(od.prototype, {
    ...
    QV: function() {
      ...
      this.page > this.Id - this.Uf &&
        this.page >= this.Uf &&
        ((d = this.Id - this.Uf + 1), (b = this.Id))
      for (e = d; e <= b; e++) {
        0 < e &&
          (e == this.page
  ...
  x.extend(bb.prototype, {
    ...
    Kp: function(a) {
      this.k.Fk =
        'number' == typeof a && !isNaN(a) ? (1 > a ? bb.aq : a > bb.Cn ? bb.aq : a) : bb.aq
    },
    lf: function() {
      return this.k.Fk
    },
  ...
  function Geolocation(a) {
    a = a || {}
    this.K = { timeout: a.timeout || 10000, maximumAge: a.maximumAge || 600000 }
    this.ke = []
    var b = this
    I.load('othersearch', function() {
  ...
  function Na(a, b) {
    function c() {
      e.k.visible
        ? ('inter' === e.Ge && e.k.haveBreakId && e.k.indoorExitControl === o
            ? x.D.show(e.uA)
            : x.D.U(e.uA),
          this.k.closeControl && this.wf && this.C && this.C.Na() === this.B
            ? x.D.show(e.wf)
            : x.D.U(e.wf),
          this.k.forceCloseControl && x.D.show(e.wf))
        : (x.D.U(e.wf), x.D.U(e.uA))
    }
  ...
  x.extend(Na.prototype, {
    ...
    Yq: function() {
      return Ta() && !G() && 'javascript' != this.k.panoramaRenderer
        ? 'flashRender'
        : !G() && Mb()
        ? 'cvsRender'
        : 'cssRender'
  ...
  function Ma(a) {
    ...
    if (
      ...
      (x.platform.Gm && -1 == navigator.userAgent.indexOf('Android 5'))
    ) {
      return (Sd = q)
    }
    var a = document.createElement('canvas'),
          ...
          if (a.id != b.Uv) {
            ...
            if (b.pl) {
              ...
              c =
                ...
                Math.cos(Nb(c)) * Math.cos(Nb(i)) * Math.sin(f / 2) * Math.sin(f / 2)
    ...
    kp: function(a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) {
        ...
        this.fo.dC(b, function(b) {
          b
            ? e.fo.qj(c.lngLat, Yd.mP, function(b) {
                if (b && b.id) {
                  var f = b.id,
                    k = b.vh,
                    b = b.wh,
  ...
  a: {
    for (
      var ce = ['t', 'webkitT', 'MozT', 'msT', 'OT'], de, ee = 0, fe = ce.length;
      ee < fe;
      ee++
    ) {
  ...
  function Fe(a, b) {
    ...
    c.options.Uk
      ? (c.Nb.style[ie] = 'translate(' + c.x + 'px,' + c.y + 'px)' + Ee)
  ...
  Fe.prototype = {
    ...
    pQ: function() {
      !this.rh &&
        !this.Wk &&
          !(
            this.Vl ||
            (this.vy == this.Nb.offsetWidth * this.scale &&
              this.Fp == this.Nb.offsetHeight * this.scale)
          ) &&
        this.refresh()
    },
    Ev: function(a) {
      ...
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ...
            this.options.kF
              ? (b.className = this.options.kF + a.toUpperCase())
              : (b.style.cssText =
    ...
    xr: function(a, b) {
      this.Wk ||
        ...
        this.options.Uk
          ? (this.Nb.style[ie] =
              'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Ee)
          : ((a = $d.round(a)),
            (b = $d.round(b)),
    ...
    oB: function(a, b) {
      ...
      this[a + 'Scrollbar'] &&
          ...
          : c > this[a + 'ScrollbarMaxScroll'] &&
            (this.options.rD
              ...
              : ((c =
                  ...
                  $d.round(3 * (c - this[a + 'ScrollbarMaxScroll']))),
                8 > c && (c = 8),
                (this[a + 'ScrollbarIndicator'].style['h' == a ? 'width' : 'height'] = c + 'px'),
        ...
        (this[a + 'ScrollbarIndicator'].style[ie] =
          'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + Ee))
    },
    AQ: function(a) {
      if (a.wR === o) {
      ...
      if ('select' != b && 'input' != b && 'textarea' != b) {
        return (
          a.stopImmediatePropagation ? a.stopImmediatePropagation() : (a.lZ = o),
          a.stopPropagation(),
          a.preventDefault(),
          (this.ax = this.NB = p),
          q
    ...
    Nv: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          te && 1 < a.touches.length &&
          ((d = $d.abs(a.touches[0].pageX - a.touches[1].pageX)),
      ...
      if (this.options.zoom && te && 1 < a.touches.length) {
        ...
        ;(6 > this.ew && 6 > this.fw) ||
          (this.options.DE &&
            (this.ew > this.fw + 5
              ? ((f = this.y), (d = 0))
              : this.fw > this.ew + 5 && ((e = this.x), (c = 0))),
          (this.rh = o),
          this.xr(e, f),
          (this.HC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.IC = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime &&
            ((this.startTime = g), (this.au = this.x), (this.bu = this.y)),
      ...
      if (!(te && 0 !== a.touches.length)) {
        ...
        if (b.Wk) {
          ...
          if (b.rh) {
            ...
            f.Aa || g.Aa
              ? ((c = $d.max($d.max(f.time, g.time), 10)),
                b.options.Yt &&
                  ((f = d - b.gw),
                  (g = e - b.hw),
                  $d.abs(f) < b.options.Fy && $d.abs(g) < b.options.Fy
                    ? b.scrollTo(b.gw, b.hw, 200)
                    : ((f = b.eJ(d, e)), (d = f.x), (e = f.y), (c = $d.max(f.time, c)))),
                b.scrollTo($d.round(d), $d.round(e), c))
              : b.options.Yt
              ? ((f = d - b.gw),
                (g = e - b.hw),
                $d.abs(f) < b.options.Fy && $d.abs(g) < b.options.Fy
    ...
    io: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.rh && ((this.rh = q), this.options.$x && this.options.$x.call(this)),
          this.mi &&
            this.options.Dx &&
            ('webkit' == be && (this.LL.style[pe] = '300ms'), (this.LL.style.opacity = '0')),
      ...
      a.Vl ||
        (a.Aj.length
          ? ((e = a.Aj.shift()),
            ...
            (a.rh = o),
            a.options.Bi)
            ? (a.nJ(e.time), a.xr(e.x, e.y), (a.Vl = q), e.time ? a.ca(Be) : a.io(0))
            : ((g = function() {
                var i = Date.now(),
                  k
                if (i >= d + e.time) {
    ...
    kI: function(a, b, c, d, e) {
      var b = $d.abs(a) / b,
        f = (b * b) / 0.0012
      0 < a && f > c
        ? ((c += e / (6 / (0.0006 * (f / b)))), (b = (b * c) / f), (f = c))
        : 0 > a && f > d && ((d += e / (6 / (0.0006 * (f / b)))), (b = (b * d) / f), (f = d))
      return { Aa: f * (0 > a ? -1 : 1), time: $d.round(b / 0.0006) }
    },
    $j: function(a) {
    ...
    refresh: function() {
      ...
      if ('string' == typeof this.options.Yt) {
        ...
        if (this.options.Yt) {
          ...
          this.ee % this.ru &&
            (this.Qe[this.Qe.length] =
              this.ee - this.Qe[this.Qe.length - 1] + this.Qe[this.Qe.length - 1])
          b = d = 0
          for (this.pf = []; d >= this.od; ) {
            ;(this.pf[b] = d), (d -= this.yn), b++
          }
          this.od % this.yn &&
            (this.pf[this.pf.length] =
              this.od - this.pf[this.pf.length - 1] + this.pf[this.pf.length - 1])
        }
      }
      this.Ev('h')
      this.Ev('v')
  ...
  z.Sm(function(a) {
    ...
    a.addEventListener('position_changed', function() {
      a.k.visible &&
        a.k.albumsControl === o &&
        (b ? b.ny(a.Yb()) : ((b = new Ge(a.k.albumsControlOptions)), b.qa(a)))
    })
    a.addEventListener('albums_visible_changed', function() {
      a.k.albumsControl === o
        ? (b ? b.ny(a.Yb()) : ((b = new Ge(a.k.albumsControlOptions)), b.qa(a)), b.show())
        : b.U()
    })
  ...
  x.extend(Ge.prototype, {
    ...
    ny: function(a, b) {
      if (
        b ||
        !this.bk[this.Yc] ||
        !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)
      ) {
        var c = this,
          d = this.BH(a)
                ...
                ;(d = a[m].catlog),
                  ...
                  j !== d &&
                    ('' === d && j !== i
                      ...
                      : (b[Ie[d]] || (b[Ie[d]] = []), b[Ie[d]].push(a[m])))
              }
              for (var u in b) {
                k ? l.push({ data: u + 'F', index: u }) : l.push({ data: Je[u], index: u })
              }
              c.TG = b
              c.Pi = l
              c.Dl(a)
    ...
    OV: function() {
      if (this.Mi) {
        ...
        var a = K('div'),
          ...
          g = K('span'),
          i = [
            'background:url(' + F.pa + 'panorama/catlog_icon.png) no-repeat;',
    ...
    PV: function() {
      if (this.Pi && !(0 >= this.Pi.length)) {
        ...
        this.Mi &&
          (this.Mi.style.left = parseInt(this.Mi.style.left, 10) + this.eg.width + 8 + 'px')
        var b = this
    ...
    Dl: function(a) {
      ...
      this.k.showCatalog &&
        (0 < this.Pi.length
          ? (Ta() ? this.OV() : this.RV(), (this.Pc.offsetLeft = 60))
          : (this.Gs &&
              (this.B.removeChild(this.Gs), (this.Gs = p), (this.Pc.fg.style.left = '0px')),
            this.Mi && (this.B.removeChild(this.Mi), (this.Mi = p)),
            (this.Pc.offsetLeft = 0)))
      var b = this.fX(a)
      Ta() &&
        this.Pi && 0 < this.Pi.length && this.k.showExit && this.Xz &&
    ...
    fX: function(a) {
      for (
        ...
        ;(b = a[k]),
          ...
          3 === recoType
            ? Ta()
              ? ((this.Xz = b), (this.zW = d), a.splice(k, 1), k--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  k +
                  '"><img style="width:' +
    ...
    eY: function() {
      this.Pc = G()
        ? new Fe(this.gk, { Bo: q, Ux: o, mi: q, Ci: q, vn: q, DE: o, Bw: o, zx: o })
        : new Ke(this.gk)
    },
    U: function() {
