<template>
  <el-popover
    popper-class="v_query_condition_more"
  ...
  >
    <div class="inside_box">
      <div class="inside_box_title">
        ...
        <div class="check-box">
          <el-button size="mini" type="text" @click="handlecheckAll">{{
            popoverAttrsBind.allTxt || '全选'
          }}</el-button>
          <el-button size="mini" type="text" @click="handleReset">{{
            popoverAttrsBind.clearTxt || '清空'
          }}</el-button>
          <el-button size="mini" type="text" @click="handleReverseCheck">{{
...
<style lang="scss">
.v_query_condition_more.el-popover {
  padding: 10px 15px;
  padding-top: 5px;
  .inside_box {
    display: flex;
