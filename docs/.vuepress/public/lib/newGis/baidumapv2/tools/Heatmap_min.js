  ...
  var heatmapFactory = (function() {
    ...
    legend.prototype = {
      init: function() {
        ...
        element.innerHTML =
          "<h3 style='padding:0;margin:0;text-align:center;font-size:16px;'>" + title + '</h3>'
      ...
      update: function(max) {
        ...
        for (var i = 0; i < gradient.length; i++) {
          ...
          labelsHtml +=
            ...
            ((((1 / (gradient.length - 1)) * i * 256 || 0) >> 0) - offset + 0.5) +
            'px">' +
            labelText +
            '</li>'
        }
    ...
    heatmap.prototype = {
      ...
      resize: function() {
        ...
        canvas.width = acanvas.width =
          me.get('width') || element.style.width.replace(/px/, '') || me.getWidth(element)
        this.set('width', canvas.width)
        canvas.height = acanvas.height =
          me.get('height') || element.style.height.replace(/px/, '') || me.getHeight(element)
