...
*/
  ...
  var ForceEdgeBundling = function ForceEdgeBundling() {
    ...
    function edge_visibility(P, Q) {
      ...
      var midI = { x: (I0.x + I1.x) / 2.0, y: (I0.y + I1.y) / 2.0 }
      var midP = {
        x: (data_nodes[P.source].x + data_nodes[P.target].x) / 2.0,
        y: (data_nodes[P.source].y + data_nodes[P.target].y) / 2.0
      }
        ...
        if (type === 'LineString') {
          ...
          for (var j = 0; j < coordinates.length; j += interval) {
            if (coordinates[j] && coordinates[j + 1]) {
              ...
              context.drawImage(
                directionImage,
                -directionImage.width / 2 / 2,
                -directionImage.height / 2 / 2,
                directionImage.width / 2,
                directionImage.height / 2
              )
              context.restore()
  ...
  function getDistance(coordinateA, coordinateB) {
    return Math.sqrt(
      Math.pow(coordinateA[0] - coordinateB[0], 2) + Math.pow(coordinateA[1] - coordinateB[1], 2)
    )
  }
      ...
      if (img) {
        ...
        if (!stacks[url]) {
          ...
          getImage(
            ...
            function(img, src) {
              stacks[src] &&
                stacks[src].forEach(function(fun) {
                  return fun(img)
                })
              stacks[src] = null
              imageMap[src] = img
        ...
        stacks[url].push(
          (function(x, y, iconWidth, iconHeight) {
            return function(img) {
              if (img === 'error') {
                drawPoint()
              } else if (iconWidth && iconHeight) {
            ...
            if (img) {
              ...
              if (!stacks$1[url]) {
                ...
                getImage$1(
                  ...
                  function(img, src) {
                    stacks$1[src] &&
                      stacks$1[src].forEach(function(fun) {
                        return fun(img)
                      })
                    stacks$1[src] = null
                    imageMap$1[src] = img
  ...
  var AnimationLayer = (function(_BaseLayer) {
    ...
    function AnimationLayer(map, dataSet, options) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (AnimationLayer.__proto__ || Object.getPrototypeOf(AnimationLayer)).call(
          this,
          map,
          dataSet,
          options
        ...
        value: function drawAnimation() {
          ...
          for (var i = 0; i < data.length; i++) {
            if (data[i].geometry.type === 'Point') {
              ...
              ctx.lineWidth = 1
              ctx.strokeStyle =
                data[i].strokeStyle || data[i]._strokeStyle || options.strokeStyle || 'yellow'
              ctx.stroke()
  ...
  if (global$6.google && global$6.google.maps) {
    ...
    CanvasLayer$2.prototype.requestAnimFrame_ =
      ...
      global$6.webkitRequestAnimationFrame ||
      global$6.mozRequestAnimationFrame ||
      global$6.oRequestAnimationFrame ||
      global$6.msRequestAnimationFrame ||
      function(callback) {
    ...
    CanvasLayer$2.prototype.cancelAnimFrame_ =
      global$6.cancelAnimationFrame ||
      global$6.webkitCancelAnimationFrame ||
      global$6.mozCancelAnimationFrame ||
      global$6.oCancelAnimationFrame ||
      global$6.msCancelAnimationFrame ||
      function(requestId) {}
    ...
    CanvasLayer$2.prototype.repositionCanvas_ = function() {
      ...
      this.canvas.style[CanvasLayer$2.CSS_TRANSFORM_] =
  ...
  if (typeof maptalks !== 'undefined') {
    Layer$4 = (function(_maptalks$Layer) {
      ...
      function Layer(id, dataSet, options) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (Layer.__proto__ || Object.getPrototypeOf(Layer)).call(this, id, options)
        )
    ...
    var LayerRenderer = (function(_maptalks$renderer$Ca) {
      ...
      function LayerRenderer() {
        ...
        return possibleConstructorReturn(
          this,
          (LayerRenderer.__proto__ || Object.getPrototypeOf(LayerRenderer)).apply(this, arguments)
        )
      }
      ...
      createClass(LayerRenderer, [
        {
          ...
          value: function needToRedraw() {
            ...
            return get(
              LayerRenderer.prototype.__proto__ || Object.getPrototypeOf(LayerRenderer.prototype),
              'needToRedraw',
              this
            ).call(this)
          }
        ...
        },
        {
          ...
          value: function _update(context, time) {
            ...
            var dataGetOptions = {
              fromColumn:
                self.options.coordType === 'bd09mc' ? 'coordinates_mercator' : 'coordinates',
              transferCoordinate: function transferCoordinate(coordinate) {
                coord.x = coordinate[0]
                coord.y = coordinate[1]
                var r = map
                  .coordToContainerPoint(coord)
                  ._multi(scale)
                  .toArray()
                return r
              }
          ...
          value: function createCanvas() {
            ...
            if (mapvContext === '2d') {
              ...
              if (this.layer.options['globalCompositeOperation']) {
                this.context.globalCompositeOperation = this.layer.options[
        ...
        },
        {
          ...
          value: function _bindToMapv() {
            ...
            var base = this.layer.baseLayer
            var map = this.getMap()
            this.devicePixelRatio = map.getDevicePixelRatio
              ? map.getDevicePixelRatio()
              : maptalks.Browser.retina
              ? 2
              : 1
    ...
    createClass(Layer, [
      ...
      },
      {
        ...
        value: function render(canvas, time) {
          ...
          var context = canvas.getContext(this.context)
          var animationOptions = this.options.animation
          var _projection = this.options.hasOwnProperty('projection')
            ? this.options.projection
            : 'EPSG:4326'
          var mapViewProjection = this.$Map
            .getView()
            .getProjection()
            .getCode()
          if (this.isEnabledTime()) {
          ...
          var dataGetOptions = {}
          dataGetOptions.transferCoordinate =
            _projection === mapViewProjection
              ? function(coordinate) {
              ...
              : function(coordinate) {
                  ...
                  return map.getPixelFromCoordinate(
                    ol.proj.transform(coordinate, _projection, mapViewProjection)
                  )
                }
  ...
  var MapVRenderer = (function(_BaseLayer) {
    ...
    function MapVRenderer(map, layer, dataSet, options) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (MapVRenderer.__proto__ || Object.getPrototypeOf(MapVRenderer)).call(
          this,
          map,
          dataSet,
          options
    ...
    createClass(MapVRenderer, [
      {
        ...
        value: function clickEvent(e) {
          ...
          var devicePixelRatio = (this.devicePixelRatio = this.canvasLayer.devicePixelRatio =
            window.devicePixelRatio)
          var pixel = e.layerPoint
          get(
            MapVRenderer.prototype.__proto__ || Object.getPrototypeOf(MapVRenderer.prototype),
            'clickEvent',
            this
          ).call(
            this,
            L.point(
              (pixel.x - offset.x) / devicePixelRatio,
              (pixel.y - offset.y) / devicePixelRatio
            ),
            e
          )
        }
  ...
  if (typeof L !== 'undefined') {
    ...
    var MapVLayer = L.Layer.extend({
      ...
      onAdd: function onAdd(map) {
        ...
        var container = (this.container = L.DomUtil.create(
          'div',
        ...
        value: function _canvasUpdate(t) {
          ...
          if (this.canvasLayer && !this.stopAniamation) {
            ...
            this.processData(c),
              ...
              (this.options._size = this.options.size)
            var h = Cesium.SceneTransforms.wgs84ToWindowCoordinates(
              e,
