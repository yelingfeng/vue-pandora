        ...
        p = Object(r.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '单选-开启键盘事件-上下选择高亮-回车选中' } }, [
                  a(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#单选-开启键盘事件-上下选择高亮-回车选中' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' 单选--开启键盘事件（上下选择高亮，回车选中）')
                ]),
                t._v(' '),
                a('hr'),
                t._v(' '),
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-isKeyup', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      t._v(' '),
                      a('code', [t._v('isKeyup')]),
                      t._v(' 是否开启键盘事件（默认不开启）上下选择高亮，回车选中'),
                      a('br'),
                      t._v(' '),
                      ...
                      a('br'),
                      t._v('\n设置'),
                      a('code', [t._v('max-height')]),
                      t._v('键盘向上/下滚动条可根据移动的选择区域而滚动')
                    ]),
                    t._v(' '),
