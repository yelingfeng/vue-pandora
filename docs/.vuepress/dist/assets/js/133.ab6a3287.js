        ...
        p = Object(r.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '多选-禁用' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#多选-禁用' } }, [
                    t._v('#')
                  ]),
                  t._v(' 多选--禁用')
                ]),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-selectable', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      t._v(' 开启多选；设置'),
                      a('code', [t._v('selectable')]),
                      t._v('属性其类型：'),
                      a('code', [t._v('Function(row: any, index: number)')]),
                      t._v(' 可根据返回值来决定 '),
                      a('code', [t._v('CheckBox')]),
                      t._v(' 是否可以勾选.。')
                    ]),
                    t._v(' '),
