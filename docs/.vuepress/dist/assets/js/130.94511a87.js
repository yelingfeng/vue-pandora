        ...
        r = Object(n.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '单选开启分页功能' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#单选开启分页功能' } }, [
                    t._v('#')
                  ]),
                  t._v(' 单选开启分页功能')
                ]),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-radioPagination', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      a('br'),
                      t._v(' '),
                      a('code', [t._v('@radioChange="radioChange""')]),
                      t._v('事件返回选中的数据')
                    ]),
                    t._v(' '),
