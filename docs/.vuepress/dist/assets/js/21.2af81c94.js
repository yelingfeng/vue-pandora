        ...
        p = {
          ...
          methods: {
            radioChange: function(e) {
              console.log('单选--返回选中的数据', e)
            },
            pageChange: function(e) {
              console.log('获取当前的页码', e),
                (this.table.currentPage = e),
                2 == e
                  ? ((this.defaultSelectVal = ['1567343444607168514']),
                    (this.radioSelectValLabel = ''))
                  : ((this.defaultSelectVal = []), (this.radioSelectValLabel = 'GG1011')),
                  ...
                  return Object(r.a)().wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 9:
                          l.success &&
                            ((a.table.data = l.data.records), (a.table.total = l.data.total))
                        case 10:
                        case 'end':
                          return t.stop()
                      }
                  ...
                  [
                    a('v-select-table', {
                      ...
                      attrs: {
                        ...
                        radioSelectValLabel: this.radioSelectValLabel,
                        defaultSelectVal: this.defaultSelectVal,
                        isShowPagination: ''
                      },
                      on: { 'page-change': this.pageChange, radioChange: this.radioChange }
                    })
                  ],
                  1
                )
