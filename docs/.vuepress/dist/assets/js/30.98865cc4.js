        ...
        o = {
          ...
          data: function() {
            ...
            return {
              ...
              table: {
                    ...
                    render: function(t, l) {
                      return a(
                        'el-switch',
                        {
                          ...
                          on: {
                            change: function() {
                              return e.handleStatusChange(l)
                            }
                          },
                          model: {
                            value: l.enableStatus,
                            callback: function(a) {
                              e.$set(l, 'enableStatus', a)
                            }
                          }
                        },
                        [t]
                ...
                operator: [
                  { text: '查看', fun: this.viewDetail },
                  { text: '编辑', fun: this.edit }
                ],
                operatorConfig: { fixed: 'right', width: 160, label: '操作' }
              },
              ADDRESS_TYPES: [
                { label: '前纺一车间', key: 'W1' },
                { label: '前纺二车间', key: 'W2' },
          ...
          computed: {
            ...
            getQueryData: function() {
              ...
              return {
                ...
                workshopNum: i,
                workshopNum1: o,
                beginDate: p && p[0] ? p[0] : null,
                endDate: p && p[1] ? p[1] : null
              }
            }
          },
          created: function() {
          ...
          methods: {
            cancelSelect: function() {
              this.VAdaptivePageTable.clearSelection()
            },
            selectionChange: function(e) {
              this.ids = e.map(function(e) {
                return e.id
              })
            },
            getData: function() {
                  ...
                  return Object(l.a)().wrap(function(a) {
                    for (;;)
                      switch ((a.prev = a.next)) {
                        ...
                        case 2:
                          ;(t = a.sent).success &&
                            ((e.table.data = t.data.records), (e.table.total = t.data.total))
                        case 4:
                        case 'end':
                          return a.stop()
                      }
        ...
        n = Object(p.a)(
          ...
          function() {
            var e = this,
              a = e.$createElement,
              t = e._self._c || a
            return t('v-adaptive-page', {
              attrs: {
                opts: e.opts,
                title: 'content插槽使用',
                'table-ref': e.VAdaptivePageTable,
                isCopy: '',
                table: e.table,
                tablePageStyle: { marginTop: 0 },
                columns: e.table.columns,
                isShowPagination: e.isShowPagination
              },
              on: {
                submit: e.conditionEnter,
                'update:tableRef': function(a) {
                  e.VAdaptivePageTable = a
                },
                'update:table-ref': function(a) {
                  e.VAdaptivePageTable = a
                },
              ...
              scopedSlots: e._u([
                {
                  ...
                  fn: function() {
                    return [
                      t('v-layout-page-item', [
                        t('div', [e._v('条件查询与TTable组件之间contnet插槽')])
                      ])
                    ]
                  },
                  proxy: !0
                  ...
                  fn: function() {
                    return [
                      t(
                        'el-button',
                        {
                          attrs: { size: 'default', type: 'primary', disabled: e.ids.length < 1 },
