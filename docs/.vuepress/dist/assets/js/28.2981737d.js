  ...
  [28],
  {
    744: function(t, n, e) {
      ...
      function p(t, n, e) {
        ...
        e &&
          (n = (function(t, n, e) {
            ...
            for (var u = t.replace(/^\//, '').split('/'), a = 0; a < u.length; a++) {
              var o = u[a]
              '..' === o ? i.pop() : '.' !== o && i.push(o)
            }
            '' !== i[0] && i.unshift('')
      ...
      function d(t, n, e, r) {
        var i = e.pages,
          u = e.themeConfig,
          a = (r && u.locales && u.locales[r]) || u
        if ('auto' === (t.frontmatter.sidebar || a.sidebar || u.sidebar)) return g(t)
        var o = a.sidebar || u.sidebar
        if (o) {
          var s = (function(t, n) {
          ...
          return 'auto' === l
            ...
            ? l.map(function(t) {
                return (function t(n, e, r) {
                  ...
                  if ('string' == typeof n) return p(e, n, r)
                  if (Array.isArray(n)) return Object.assign(p(e, n[0], r), { title: n[1] })
                  var u = n.children || []
                  return 0 === u.length && n.path
                    ? Object.assign(p(e, n.path, r), { title: n.title })
                    : {
                        type: 'group',
                        path: n.path,
                        title: n.title,
