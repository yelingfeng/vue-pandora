        ...
        r = Object(n.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '单选-回显不是第一页的label' } }, [
                  a(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#单选-回显不是第一页的label' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' 单选--回显不是第一页的label')
                ]),
                t._v(' '),
                a('hr'),
                t._v(' '),
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-defaultSelectValLabel', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      a('br'),
                      t._v(' '),
                      a('code', [t._v('radioSelectValLabel')]),
                      t._v(' 回显的label文字同时需动态设置'),
                      a('code', [t._v('defaultSelectVal')]),
                      t._v('才会有选中效果'),
                      a('br')
                    ]),
                    t._v(' '),
