          ...
          function() {
            ...
            return a(
              ...
              [
                a(
                  'h1',
                  { attrs: { id: '调用handleevent动态修改查询条件值v1-4-13' } },
                  [
                    a(
                      'a',
                      {
                        staticClass: 'header-anchor',
                        attrs: { href: '#调用handleevent动态修改查询条件值v1-4-13' }
                      },
                      [t._v('#')]
                    ),
                    t._v(' 调用handleEvent动态修改查询条件值'),
                    a('el-tag', [t._v('v1.4.13')])
                  ],
                  1
                ),
                t._v(' '),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VQueryCondition-handleEventChange', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      t._v('最终方法调用'),
                      a('code', [t._v("this.$refs.queryCondition.change('W1', 'workshopNum')")]),
                      t._v('。'),
                      a('br')
                    ]),
                    t._v(' '),
                    ...
                    t._v(' '),
                    a('p', [
                      a('code', [t._v('queryCondition')]),
                      t._v('条件查询的'),
                      a('code', [t._v('ref')]),
                      t._v('；'),
                      a('code', [t._v("change('W1', 'workshopNum')")]),
                      t._v('方法，'),
                      a('br')
                    ]),
                    t._v(' '),
