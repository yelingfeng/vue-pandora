  ...
  [3, 18, 27],
  {
    744: function(t, e, n) {
      ...
      function h(t, e, n) {
        ...
        for (var r = o(e), i = 0; i < t.length; i++)
      ...
      function f(t, e, n, r) {
        ...
        if ('auto' === (t.frontmatter.sidebar || s.sidebar || a.sidebar)) return b(t)
    ...
    761: function(t, e, n) {
      ...
      function s(t, e) {
        if ('group' === e.type) {
          var n = e.path && Object(a.e)(t, e.path),
            r = e.children.some(function(e) {
              return 'group' === e.type ? s(t, e) : 'page' === e.type && Object(a.e)(t, e.path)
            })
          return n || r
        }
        return !1
      ...
      var o = {
          name: 'SidebarLinks',
          components: { SidebarGroup: r.default, SidebarLink: i.default },
          ...
          methods: {
            ...
            isActive: function(t) {
              return Object(a.e)(this.$route, t.regularPath)
            }
          }
        },
        u = n(58),
    ...
    763: function(t, e, n) {
      ...
      function i(t, e, n, r, i) {
        ...
        return i > 2 && (a.style = { 'padding-left': i + 'rem' }), t('RouterLink', a, n)
      }
      function a(t, e, n, s, o) {
        ...
        return !e || u > o
          ...
          : t(
              ...
              e.map(function(e) {
                var l = Object(r.e)(s, n + '#' + e.slug)
                return t('li', { class: 'sidebar-sub-header' }, [
                  i(t, n + '#' + e.slug, e.title, l, e.level - 1),
                  a(t, e.children, n, s, o, u + 1)
                ])
              })
            )
      }
      var s = {
          ...
          render: function(t, e) {
            var n = e.parent,
              ...
              p = c.item,
              d = c.sidebarDepth,
              h = Object(r.e)(o, p.path),
              f =
                'auto' === p.type
                  ? h ||
                    p.children.some(function(t) {
                      return Object(r.e)(o, p.basePath + '#' + t.slug)
                    })
                  : h,
              b =
                'external' === p.type
                  ...
                  : i(t, p.path, p.title || p.path, f),
              g = [s.frontmatter.sidebarDepth, d, l.sidebarDepth, u.sidebarDepth, 1].find(function(
                t
              ) {
                return void 0 !== t
              }),
              m = l.displayAllHeaders || u.displayAllHeaders
            return 'auto' === p.type
              ? [b, a(t, p.children, p.basePath, o, g)]
              : (f || m) && p.headers && !r.d.test(p.path)
              ? [b, a(t, Object(r.c)(p.headers), p.path, o, g)]
              : b
          }
        },
        o = (n(759), n(58)),
        u = Object(o.a)(s, void 0, void 0, !1, null, null, null)
      e.default = u.exports
    },
    771: function(t, e, n) {
      'use strict'
