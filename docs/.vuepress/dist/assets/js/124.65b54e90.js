        ...
        p = Object(r.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '多选-默认选中' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#多选-默认选中' } }, [
                    t._v('#')
                  ]),
                  t._v(' 多选（默认选中）')
                ]),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-multipleDefaultSelectVal', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      t._v('类型（即：'),
                      a('code', [t._v('keywords.value')]),
                      t._v('是"id",那么需要默认选中哪项就输入该项'),
                      a('code', [t._v('table.data')]),
                      t._v('数据的'),
                      a('code', [t._v('id')]),
                      t._v('值即可）'),
                      a('br'),
