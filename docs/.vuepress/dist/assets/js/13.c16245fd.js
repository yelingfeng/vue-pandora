  ...
  [13, 16, 17],
  {
    744: function(t, e, n) {
      ...
      function h(t, e, n, r) {
        ...
        if ('auto' === (t.frontmatter.sidebar || s.sidebar || a.sidebar)) return v(t)
          ...
          return 'auto' === l
            ...
            ? l.map(function(t) {
                return (function t(e, n, r) {
                  ...
                  if (Array.isArray(e)) return Object.assign(d(n, e[0], r), { title: e[1] })
                  var a = e.children || []
          ...
          computed: {
            ...
            editLink: function() {
              ...
              return t && c && this.$page.relativePath
                ? this.createEditLink(n, c, a, o, this.$page.relativePath)
                : null
            },
    ...
    778: function(t, e, n) {
      ...
      var r = n(744),
        ...
        u = {
          ...
          computed: {
            prev: function() {
              return l(c.PREV, this)
            },
            next: function() {
              return l(c.NEXT, this)
            }
          }
        }
      var c = {
      ...
      function l(t, e) {
        var n = e.$themeConfig,
          ...
          h = f(i),
          v = o()(h) ? d : h
        return !1 === v ? void 0 : a()(v) ? Object(r.k)(u.pages, v, s.path) : l(i, c)
      }
      function p(t, e, n) {
        var r = []
        !(function t(e, n) {
        ...
        for (var i = 0; i < r.length; i++) {
          var a = r[i]
          if ('page' === a.type && a.path === decodeURIComponent(t.path)) return r[i + n]
        }
      }
      var f = u,
        d = (n(769), n(58)),
    ...
    797: function(t, e, n) {
      ...
      var r = n(777),
        i = n(778),
        a = { components: { PageEdit: r.default, PageNav: i.default }, props: ['sidebarItems'] },
        s = (n(781), n(58)),
        o = Object(s.a)(
          a,
          function() {
