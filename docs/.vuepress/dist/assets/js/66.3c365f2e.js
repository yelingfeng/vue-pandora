            ...
            opts: function() {
              ...
              return {
                ...
                date: {
                  ...
                  comp: 't-date-picker',
                  span: 2,
                  bind: { type: 'datetimerange', 'default-time': ['00:00:00', '23:59:59'] }
                },
                date2: { label: '日期', comp: 't-date-picker', span: 2, bind: { type: 'date' } },
                workshopNum: {
                  label: '车间',
                  comp: 'el-select',
                  changeEvent: 'change',
                ...
                likeTransportNo: { label: '运单编号', comp: 'el-input', span: 2 },
                likeCargoName: { label: '货品名称', comp: 'el-input', span: 2 }
              }
            }
          },
          methods: {
                ...
                a(
                  ...
                  [
                    a('v-select-table', {
                      ...
                      on: { radioChange: this.radioChange, submit: this.conditionEnter }
                    })
                  ],
                  1
                )
