        ...
        p = Object(r.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '单选-默认选中' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#单选-默认选中' } }, [
                    t._v('#')
                  ]),
                  t._v(' 单选（默认选中）')
                ]),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VSelectTable-radioDefaultSelectVal', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      ...
                      a('code', [t._v('第一页')]),
                      t._v('默认选中项（即'),
                      a('code', [t._v('keywords.value')]),
                      t._v('值）是'),
                      a('code', [t._v('Array')]),
                      t._v(
                        '类型（即：keywords.value是"id",那么需要默认选中哪项就输入该项table.data数据的id值即可）'
                      ),
                      a('br'),
                      t._v(' '),
