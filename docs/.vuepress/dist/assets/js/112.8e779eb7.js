        ...
        p = Object(r.a)(
          ...
          function() {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: '收起时默认显示几行' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#收起时默认显示几行' } }, [
                    t._v('#')
                  ]),
                  t._v(' 收起时默认显示几行')
                ]),
                ...
                a(
                  'common-code-format',
                  [
                    a('docsComponents-VQueryCondition-maxVisibleSpans', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    a('p', [
                      t._v('在组件中需开启: '),
                      a('code', [t._v('isShowOpen')]),
                      t._v('默认开启（即：'),
                      a('code', [t._v('isShowOpen：true')]),
                      t._v('生效）')
                    ]),
                    t._v(' '),
                    a('p', [t._v('设置'), a('code', [t._v('maxVisibleRows')]), t._v('默认值1')]),
                    t._v(' '),
