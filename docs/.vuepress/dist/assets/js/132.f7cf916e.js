        ...
        p = Object(n.a)(
          ...
          function() {
            ...
            return s(
              ...
              [
                s('h1', { attrs: { id: '单选-不开启整行选中' } }, [
                  s(
                    'a',
                    { staticClass: 'header-anchor', attrs: { href: '#单选-不开启整行选中' } },
                    [t._v('#')]
                  ),
                  t._v(' 单选-不开启整行选中')
                ]),
                ...
                s(
                  'common-code-format',
                  [
                    s('docsComponents-VSelectTable-rowClickRadio', {
                      attrs: { slot: 'source' },
                      slot: 'source'
                    }),
                    t._v(' '),
                    s('p', [
                      ...
                      s('br'),
                      t._v(' '),
                      s('code', [t._v('rowClickRadio')]),
                      t._v(' 是否开启整行选中功能（默认开启）')
                    ]),
                    t._v(' '),
