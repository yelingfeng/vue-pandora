      ...
      var l = t(61),
                  ...
                  return Object(l.a)().wrap(function(a) {
                    for (;;)
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (e.tableLoading = !0), (a.next = 3), o
                        case 3:
                          ;(t = a.sent).success &&
                            ((e.table.data = t.data.records),
                            (e.table.total = t.data.total),
                            setTimeout(function() {
                              e.tableLoading = !1
                            }, 3e3))
                        case 5:
        ...
        m = Object(p.a)(
          ...
          function() {
            var e = this,
              a = e.$createElement
            return (e._self._c || a)('v-adaptive-page', {
              attrs: {
                opts: e.opts,
                tableTitle: '工厂物料清单管理',
                isCopy: '',
              ...
              scopedSlots: e._u([
                {
                  key: 'title',
                  fn: function() {
                    return [e._v('优先展示插槽，不写插槽展示tableTitle')]
                  },
                  proxy: !0
                }
              ])
