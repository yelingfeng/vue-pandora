          ...
          return (function(t) {
            ...
            function(t, e, n) {
              ...
              function i(t, e) {
                ...
                'function' == typeof Error.captureStackTrace
                  ...
                  : (i.stack = new Error().stack || 'Cannot get a stacktrace, browser is too old'),
            ...
            function(t, e, n) {
              ...
              r.isMsie() &&
                ...
                r.isMsie() && r.isMsie() <= 7 && r.mixin(i.input, { marginTop: '-1px' }),
                (t.exports = i)
            },
            function(t, e) {
                      ...
                      return (
                        ...
                        (O.init = function(t, e) {
                          ...
                          if ('string' == typeof t)
                            ...
                            else if (d.test(t)) (r = O.fragment(t.trim(), RegExp.$1, e)), (t = null)
                            else {
                              if (void 0 !== e) return n(e).find(t)
                              r = O.qsa(l, t)
                            }
                        ...
                        (n.map = function(t, e) {
                          ...
                          else for (s in t) null != (r = e(t[s], s)) && a.push(r)
                          return (o = a).length > 0 ? n.fn.concat.apply([], o) : o
                        }),
                        (n.each = function(t, e) {
                          var n, r
                          if (q(t)) {
                        ...
                        (n.fn = {
                          ...
                          closest: function(t, e) {
                            ...
                            return (
                              this.each(function(n, s) {
                                for (; s && !(i ? i.indexOf(s) >= 0 : O.matches(s, t)); )
                          ...
                          wrap: function(t) {
                            ...
                            return this.each(function(s) {
                              n(this).wrapAll(e ? t.call(this, s) : i ? r.cloneNode(!0) : r)
                            })
                          },
                          wrapAll: function(t) {
                            if (this[0]) {
                            ...
                            return 'string' != typeof t || 1 in arguments
                              ? this.each(function(r) {
                                  if (1 === this.nodeType)
                                    ...
                                    else J(this, t, K(this, n, r, this.getAttribute(t)))
                                })
                              : 0 in this &&
                                1 == this[0].nodeType &&
                          ...
                          css: function(t, r) {
                            if (arguments.length < 2) {
                              ...
                              if ('string' == typeof t) {
                                if (!s) return
                                return s.style[i(t)] || getComputedStyle(s, '').getPropertyValue(t)
                              }
                              if (N(t)) {
                                if (!s) return
                                var o = {},
                                ...
                                return (
                                  n.each(t, function(t, e) {
                                    o[e] = s.style[i(e)] || a.getPropertyValue(e)
                                  }),
                                  o
                                )
                              }
                          ...
                          position: function() {
                            if (this.length) {
                              var t = this[0],
                                e = this.offsetParent(),
                                r = this.offset(),
                                i = v.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset()
                              return (
                        ...
                        ['after', 'prepend', 'before', 'append'].forEach(function(e, r) {
                          ...
                          ;(n.fn[e] = function() {
                            ...
                            (n.fn[i ? e + 'To' : 'insert' + (r ? 'Before' : 'After')] = function(
                              t
                            ) {
                    ...
                    (function(e) {
                        ...
                        n.split(/\s/).forEach(function(n) {
                          ...
                          ;(o.proxy = function(e) {
                            if (!(e = x(e)).isImmediatePropagationStopped()) {
                              try {
                                var n = Object.getOwnPropertyDescriptor(e, 'data')
                                ;(n && !n.writable) || (e.data = i)
                              } catch (e) {}
                              var r = c.apply(t, null == e._args ? [e] : [e].concat(e._args))
                              return !1 === r && (e.preventDefault(), e.stopPropagation()), r
                            }
                          }),
                            (o.i = p.length),
                            p.push(o),
                            'addEventListener' in t && t.addEventListener(g(o.e), o.proxy, d(o, u))
                        })
                      }
                      ...
                      ;(e.fn.delegate = function(t, e, n) {
                        ...
                        (e.fn.on = function(t, n, o, a, u) {
                          ...
                          return t && !s(t)
                            ? (e.each(t, function(t, e) {
                              ...
                              h)
                            : (s(n) || i(a) || !1 === a || ((a = o), (o = n), (n = void 0)),
                              (void 0 !== a && !1 !== o) || ((a = o), (o = void 0)),
                              !1 === a && (a = b),
                              h.each(function(i, s) {
                                u &&
                                  (c = function(t) {
                                    return v(s, t.type, a), a.apply(this, arguments)
                                  }),
                                  n &&
                                    (l = function(t) {
                                      var i,
                                      ...
                                      if (o && o !== s)
                                        return (
                                          (i = e.extend(S(t), { currentTarget: o, liveFired: s })),
                                          (c || a).apply(o, [i].concat(r.call(arguments, 1)))
                                        )
                                    }),
                                  m(s, t, a, o, n, l || c)
                              }))
                        ...
                        (e.fn.trigger = function(t, n) {
                          return (
                            ((t = s(t) || e.isPlainObject(t) ? e.Event(t) : x(t))._args = n),
                            this.each(function() {
                              ...
                              return (
                                t.each(e.attributes || s, function(e, i) {
                                  0 == i.name.indexOf('data-') &&
                                    (n[r(i.name.replace('data-', ''))] = t.zepto.deserializeValue(
                                      i.value
                                    ))
                                }),
                                n
            ...
            function(t, e, n) {
              'use strict'
              Object.defineProperty(e, '__esModule', { value: !0 }), (e.default = '2.6.3')
            },
            function(t, e, n) {
              'use strict'
              var r,
              ...
              var f = (function() {
                function t(e) {
                  var n = e.apiKey,
                    ...
                    w = void 0 === b ? { debug: !1, hint: !1, autoselect: !0 } : b,
                    _ = e.transformData,
                    x = void 0 !== _ && _,
                    S = e.queryHook,
                    C = void 0 !== S && S,
                        ...
                        value: function(e, n) {
                          ...
                          return function(i, s) {
                            n && (i = n(i) || i),
                              r.client
                                .search([
                                  { indexName: r.indexName, query: i, params: r.algoliaOptions }
                                ])
                                .then(function(n) {
                                  r.queryDataCallback &&
                    ...
                    [
                      {
                        ...
                        value: function(e) {
                          ...
                          if (!t.getInputFromSelector(e.inputSelector))
                            throw new Error(
                              'Error: No input element in the page matches ' + e.inputSelector
                            )
                        }
                      },
                      {
                      ...
                      },
                      {
                        ...
                        value: function() {
                          ;(0, h.default)('.searchbox [type="reset"]').on('click', function() {
                            ;(0, h.default)('input#docsearch').focus(),
                              (0, h.default)(this).addClass('hide'),
                              a.default.autocomplete.setVal('')
                          }),
                            (0, h.default)('input#docsearch').on('keyup', function() {
                      ...
                      },
                      {
                        ...
                        value: function(e) {
                          var n = c.default.deepClone(e).map(function(t) {
                              return (
                                t._highlightResult &&
                                  (t._highlightResult = c.default.mergeKeyWithParent(
                                    t._highlightResult,
                                    'hierarchy'
                                  )),
                          ...
                          return (
                            h.default.each(r, function(t, e) {
                              var n = c.default.groupBy(e, 'lvl1'),
                                i = c.default.flattenAndFlagFirst(n, 'isSubCategoryHeader')
                              r[t] = i
                            }),
                            (r = c.default.flattenAndFlagFirst(r, 'isCategoryHeader')).map(function(
                              e
                            ) {
                              var n = t.formatURL(e),
                                r = c.default.getHighlightedValue(e, 'lvl0'),
                                i = c.default.getHighlightedValue(e, 'lvl1') || r,
                                s = c.default
                                  .compact([
                                    c.default.getHighlightedValue(e, 'lvl2') || i,
                      ...
                      },
                      {
                        ...
                        value: function(t) {
                          ...
                          return e
                            ...
                            : n
                            ? '#' + t.anchor
                            : (console.warn('no anchor nor url for : ', JSON.stringify(t)), null)
                        }
                      },
                      {
                      ...
                      },
                      {
                        ...
                        value: function(t) {
                          var e = t ? u.default.suggestionSimple : u.default.suggestion,
            ...
            function(t, e, n) {
              var r = n(27)
              ;(r.Template = n(28).Template), (r.template = r.Template), (t.exports = r)
            },
            function(t, e, n) {
              !(function(t) {
                var e = /\S/,
                ...
                ;(t.tags = {
                  ...
                  (t.scan = function(n, r) {
                    ...
                    function b(n, r) {
                      if (
                            ...
                            for (var n = !0, r = g; r < p.length; r++)
                              if (
                                !(n =
                                  ...
                                  ('_t' == p[r].tag && null === p[r].text.match(e)))
                              )
                                return !1
                            return n
                          })())
                        ...
                        for (var i, s = g; s < p.length; s++)
                          p[s].text &&
                            ((i = p[s + 1]) && '>' == i.tag && (i.indent = p[s].text.toString()),
                            p.splice(s, 1))
                      else r || p.push({ tag: '\n' })
                      ;(f = !1), (g = p.length)
                    }
                    ...
                    for (r && ((r = r.split(' ')), (m = r[0]), (v = r[1])), d = 0; d < s; d++)
                      0 == o
                        ? c(m, n, d)
                          ? (--d, y(), (o = 1))
                          : '\n' == n.charAt(d)
                        ...
                        : 1 == o
                        ? ((d += m.length - 1),
                          '=' == (a = (l = t.tags[n.charAt(d + 1)]) ? n.charAt(d + 1) : '_v')
                            ? ((d = w(n, d)), (o = 0))
                            : (l && d++, (o = 2)),
                          (f = d))
                        : c(v, n, d)
                        ? (p.push({
                          ...
                          '{' == a &&
                            ('}}' == v
                              ? d++
                              : '}' === (i = p[p.length - 1]).n.substr(i.n.length - 1) &&
                ...
                function f(t) {
                  ...
                  return (
                    ...
                    (function(t) {
                      var e = []
                      for (var n in t) e.push('"' + g(n) + '": function(c,p,t,i) {' + t[n] + '}')
                      return '{ ' + e.join(',') + ' }'
                    })(t.subs)
                  )
                }
                ...
                function v(t, e) {
                  ...
                  return (
                    ...
                    (e.code += 't.b(t.rp("' + g(n) + '",c,p,"' + (t.indent || '') + '"));'),
                    n
                  )
                }
                function y(t, e) {
                  e.code += 't.b(t.t(t.' + m(t.n) + '("' + g(t.n) + '",c,p,0)));'
                }
                function b(t) {
                  return 't.b(' + t + ');'
                }
                ;(t.generate = function(e, n, r) {
                  ...
                  return (
                    t.walk(e, i), r.asString ? this.stringify(i, n, r) : this.makeTemplate(i, n, r)
                  )
                }),
                  ...
                  (t.codegen = {
                    ...
                    '^': function(e, n) {
                      ;(n.code +=
                        'if(!t.s(t.' + m(e.n) + '("' + g(e.n) + '",c,p,1),c,p,1,0,0,"")){'),
                        t.walk(e.nodes, n),
                        (n.code += '};')
                    },
                    '>': v,
                    ...
                    _v: function(t, e) {
                      e.code += 't.b(t.v(t.' + m(t.n) + '("' + g(t.n) + '",c,p,0)));'
                    },
                    _t: function(t, e) {
                      e.code += b('"' + g(t.text) + '"')
                    },
                  ...
                  (t.parse = function(e, n, r) {
                    return (function e(n, r, i, s) {
                      ...
                      for (o = i[i.length - 1]; n.length > 0; ) {
                        if (((c = n.shift()), o && '<' == o.tag && !(c.tag in l)))
                  ...
                  (t.compile = function(e, n) {
                    ...
                    return (
                      (i = this.generate(this.parse(this.scan(e, n.delimiters), e, n), e, n)),
                      (this.cache[r] = i)
                    )
                  })
              })(e)
                ...
                ;(t.Template = function(t, e, n, r) {
                  ...
                  (t.Template.prototype = {
                    ...
                    s: function(t, e, n, r, i, s, o) {
                      ...
                      return (
                        (!c(t) || 0 !== t.length) &&
                        ('function' == typeof t && (t = this.ms(t, e, n, r, i, s, o)),
                        (a = !!t),
                        !r && a && e && e.push('object' == typeof t ? t : e[e.length - 1]),
                        a)
                      )
                    },
                    d: function(t, n, r, i) {
                    ...
                    f: function(t, n, r, i) {
                      for (
                        var s = !1, o = !1, a = this.options.modelGet, u = n.length - 1;
                        u >= 0;
                        u--
                      )
                      ...
                      return o
                        ? (i || 'function' != typeof s || (s = this.mv(s, n, r)), s)
                        : !i && ''
                    },
            ...
            function(t, e, n) {
              ...
              function u(t, e, i) {
                ...
                ;(this.applicationID = t),
                  ...
                  (i = i || {}),
                  (this._timeouts = i.timeouts || { connect: 1e3, read: 2e3, write: 3e4 }),
                  i.timeout &&
                ...
                if ((this._checkAppIdData(), i.hosts))
                  a(i.hosts)
                    ...
                    : ((this.hosts.read = o(i.hosts.read)), (this.hosts.write = o(i.hosts.write)))
                else {
                ...
                ;(this.hosts.read = u(this.hosts.read, c(h))),
                  ...
                  (this.cache = i._cache || {}),
                  (this._ua = i._ua),
                  (this._useCache = !(void 0 !== i._useCache && !i._cache) || i._useCache),
              ...
              ;(u.prototype.initIndex = function(t) {
                ...
                (u.prototype._jsonRequest = function(t) {
                  ...
                  (void 0 !== t.body.params || void 0 !== t.body.requests)
                    ...
                    : (o = this._computeRequestHeaders({ additionalUA: u, headers: t.headers })),
                  ...
                  if (
                    ...
                    p._useCache && p._useRequestCache && e && (s += '_body_' + e),
                    v(p._useRequestCache, c, s))
                  ) {
                    a('serving request from cache')
                    var b = c[s]
                    return y(
                      'function' != typeof b.then ? p._promise.resolve({ responseText: b }) : b,
                      function(t) {
                  ...
                  var w = (function n(i, y) {
                    ...
                    if (
                      (p._useCache && !p._useRequestCache && (s = t.url),
                      p._useCache && !p._useRequestCache && e && (s += '_body_' + y.body),
                      v(!p._useRequestCache, c, s))
                    ) {
                    ...
                    if (f >= p.hosts[t.hostType].length)
                      return !g || d
                        ...
                        : (a('switching to fallback'),
                          ...
                          (o = p._computeRequestHeaders({ additionalUA: u, headers: t.headers })),
                      ...
                      i.call(p, x, S).then(
                        function(t) {
                          ...
                          if (
                            ...
                            return (
                              p._useCache && !p._useRequestCache && c && (c[s] = t.responseText),
                    ...
                    function C() {
                      return a('retrying request'), p._incrementHostIndex(t.hostType), n(i, y)
                    }
                  })(p._request, {
                    url: t.url,
                    method: t.method,
                  ...
                  var o = this,
                    ...
                    u = s(a.requests, function(t, e) {
                      return (
                        ...
                        '=' +
                        encodeURIComponent(
                          '/1/indexes/' + encodeURIComponent(t.indexName) + '?' + t.params
                        )
                      )
                    }).join('&')
                  return (
                  ...
                  (1 === arguments.length && 'function' == typeof arguments[0])
                    ...
                    ? ((i = arguments[0]),
                      'number' == typeof arguments[1]
                        ? (s = arguments[1])
                        : 'function' == typeof arguments[1] && ((r = arguments[1]), (s = void 0)),
                      (t = void 0),
                      (e = void 0))
            ...
            function(t, e, n) {
              ...
              var r = Object.prototype.hasOwnProperty,
                ...
                d = function(t) {
                  ...
                  if (s && t.length > 0) for (var m = 0; m < t.length; ++m) p.push(String(m))
                  else
                    for (var v in t) (d && 'prototype' === v) || !r.call(t, v) || p.push(String(v))
                  if (u)
                    for (
                      var y = (function(t) {
                      ...
                      (y && 'constructor' === l[b]) || !r.call(t, l[b]) || p.push(l[b])
                  return p
                }
              ;(d.shim = function() {
                if (Object.keys) {
            ...
            function(t, e, n) {
              ;(function(e) {
                var r,
                  ...
                  o = {
                    set: function(t, n) {
                      s.set(t, n)
                      try {
                        var r = JSON.parse(e.localStorage['algoliasearch-client-js'])
                        return (
                          (r[t] = n),
                          (e.localStorage['algoliasearch-client-js'] = JSON.stringify(r)),
                          r[t]
                        )
                      } catch (e) {
                        return a(t, e)
                    ...
                    get: function(t) {
                      try {
                        return JSON.parse(e.localStorage['algoliasearch-client-js'])[t] || null
                      } catch (e) {
                        return a(t, e)
                      }
                    }
                  ...
                  try {
                    return (
                      ...
                      (e.localStorage['algoliasearch-client-js'] ||
                        e.localStorage.setItem('algoliasearch-client-js', JSON.stringify({})),
                      !0)
                    )
                  } catch (t) {
                    return !1
                ...
                ;(r = c() ? o : s), (t.exports = { get: u, set: u, supportsLocalStorage: c })
              }.call(e, n(4)))
            },
            function(t, e, n) {
              var r
            ...
            function(t, e, n) {
              ...
              t.exports = function(t, e) {
                var s = n(12),
                  ...
                  c = n(47)
                function l(t, e, r) {
                  return ((r = n(3)(r || {}))._ua = r._ua || l.ua), new p(t, e, r)
                }
                ;(e = e || ''),
                  (l.version = n(48)),
                    ...
                    return new i(function(n, r) {
                      if (h.cors || h.hasXDomainRequest) {
                        ...
                        var i,
                          s,
                          u = e.body,
                          c = h.cors ? new XMLHttpRequest() : new XDomainRequest(),
                          l = !1
                          ...
                          (c.onload = function() {
                            if (!s) {
                              ...
                              try {
                                ...
                                t = new o.UnparsableJSON({ more: c.responseText })
                              }
                              t instanceof o.UnparsableJSON ? r(t) : n(t)
                            }
                          }),
                          (c.onerror = function(t) {
                            s || (clearTimeout(i), r(new o.Network({ more: t })))
                          }),
                      ...
                      function f() {
                        ;(l = !0), clearTimeout(i), (i = setTimeout(p, e.timeouts.complete))
                      }
                    })
                  }),
            ...
            function(t, e, n) {
              ;(function(e, n) {
                ...
                ;(r = function() {
                  ...
                  function O(e, n, r) {
                    n.constructor === e.constructor && r === _ && n.constructor.resolve === x
                      ? (function(t, e) {
                          1 === e._state
                            ? N(t, e._result)
                            : 2 === e._state
                  ...
                  function N(t, e) {
                    void 0 === t._state &&
                      ((t._result = e), (t._state = 1), 0 !== t._subscribers.length && a(R, t))
                  }
                  function I(t, e) {
                    void 0 === t._state && ((t._state = 2), (t._result = e), a(k, t))
                  }
                  function j(t, e, n, r) {
                  ...
                  function D(e, n, r, i) {
                    ...
                    void 0 !== n._state ||
                      (s && u ? E(n, o) : c ? I(n, a) : 1 === e ? N(n, o) : 2 === e && I(n, o))
                  }
                  var $ = 0
                  function P(t) {
                  ...
                  var q = (function() {
                      ...
                      return (
                        ...
                        (t.prototype._settledAt = function(t, e, n) {
                          var r = this.promise
                          void 0 === r._state &&
                            (this._remaining--, 2 === t ? I(r, n) : (this._result[e] = n)),
              ...
              t.exports = function(t, e, n) {
                if ('GET' === e.method) {
                  ...
                  ;(window[c] = function(t) {
                    !(function() {
                      ...
                      o
                        ...
                        : ((s = !0), f(), n(null, { body: t, responseText: JSON.stringify(t) }))
                  }),
                    (t += '&callback=' + c),
                    e.jsonBody && e.jsonBody.params && (t += '&' + e.jsonBody.params)
                  var h = setTimeout(function() {
                    e.debug('JSONP: Script timeout'), (o = !0), f(), n(new r.RequestTimeout())
                  }, e.timeouts.complete)
                  ;(u.onreadystatechange = function() {
                    ...
                    (u.onload = p),
                    (u.onerror = function() {
                      e.debug('JSONP: Script error'), l || o || (f(), n(new r.JSONPScriptError()))
                    }),
                    (u.async = !0),
                    (u.defer = !0),
                    (u.src = t),
              ...
              t.exports = function(t) {
                return function(e, i, s) {
                  ...
                  ;((s = (s && o(s)) || {}).hosts = s.hosts || [
                    ...
                    (0 !== arguments.length && 'object' != typeof e && void 0 !== e) ||
            ...
            function(t, e, n) {
              ...
              function a(t, e, n, a) {
                ...
                return (
                  (u.autocomplete = {}),
                  i.each(['open', 'close', 'getVal', 'setVal', 'destroy', 'getWrapper'], function(
                    t
                  ) {
              ...
              ;(a.sources = s.sources), (a.escapeHighlightedString = i.escapeHighlightedString)
              var u = 'autocomplete' in window,
                c = window.autocomplete
              ;(a.noConflict = function() {
                return u ? (window.autocomplete = c) : delete window.autocomplete, a
              }),
                (t.exports = a)
            },
            function(t, e, n) {
              ...
              function l(t) {
                ...
                ;(this.css = t.css = r.mixin({}, c, t.appendTo ? c.appendTo : {})),
                ...
                var o = (function(t) {
                  ...
                  ;(s = i
                    ...
                    (o = e
                      ...
                      .val('')
                      .addClass(r.className(t.cssClasses.prefix, t.cssClasses.hint, !0))
                    ...
                    e
                      .addClass(r.className(t.cssClasses.prefix, t.cssClasses.input, !0))
                      .attr({
                        autocomplete: 'off',
                        spellcheck: !1,
                        role: 'combobox',
                ...
                ;(t = t || {}).input || i.error('input is missing'),
                  ...
                  i.isMsie()
                    ? this.$input.on('keydown.aa keypress.aa cut.aa paste.aa', function(t) {
                        r[t.which || t.keyCode] || i.defer(i.bind(c._onInput, c, t))
                      })
                ...
                i.mixin(a.prototype, o, {
                  ...
                  _checkInputValue: function() {
                    ...
                    ;(t = this.getInputValue()),
                      ...
                      (i = this.query),
                      (n =
                        !(!(e = a.normalizeQuery(r) === a.normalizeQuery(i)) || !this.query) &&
                  ...
                  clearHintIfInvalid: function() {
                    var t, e, n
                    ;(n =
                      (t = this.getInputValue()) !== (e = this.getHint()) && 0 === e.indexOf(t)),
            ...
            function(t, e, n) {
              ...
              var r,
                ...
                c = !1
              function l() {
                r && i && ((r = !1), i.length ? (u = i.concat(u)) : (a = -1), u.length && h())
              }
              function h() {
                if (!r) {
                  ;(c = !1), (r = !0)
            ...
            function(t, e, n) {
              ...
              function u(t) {
                ...
                var c = r.className(this.cssClasses.prefix, this.cssClasses.suggestion)
                ;(this.$menu = i
                  .element(t.menu)
                  ...
                  t.templates &&
                    ...
                    (this.$empty = i.element(
                      '<div class="' +
                        r.className(this.cssClasses.prefix, this.cssClasses.empty, !0) +
                        '"></div>'
                    )),
                  ...
                  (this.datasets = r.map(t.datasets, function(e) {
                    return (function(t, e, n) {
                      return new u.Dataset(r.mixin({ $menu: t, cssClasses: n }, e))
              ...
              r.mixin(u.prototype, s, {
                ...
                _onSuggestionMouseEnter: function(t) {
                  ...
                  if (
                    !e.hasClass(r.className(this.cssClasses.prefix, this.cssClasses.cursor, !0))
                  ) {
                    this._removeCursor()
                    var n = this
                    setTimeout(function() {
                ...
                _onSuggestionMouseLeave: function(t) {
                  ;(t.relatedTarget &&
                    i
                      ...
                      .closest(
                        '.' + r.className(this.cssClasses.prefix, this.cssClasses.cursor, !0)
                      ).length > 0) ||
                ...
                _getSuggestions: function() {
                  return this.$menu.find(
                    r.className(this.cssClasses.prefix, this.cssClasses.suggestion)
                  )
                },
                _getCursor: function() {
                  return this.$menu
                    .find(r.className(this.cssClasses.prefix, this.cssClasses.cursor))
                    .first()
                },
                _setCursor: function(t, e) {
                  t
                    .first()
                    .addClass(r.className(this.cssClasses.prefix, this.cssClasses.cursor, !0))
                    .attr('aria-selected', 'true'),
                    this.trigger('cursorMoved', e)
                },
                _removeCursor: function() {
                  this._getCursor()
                    .removeClass(r.className(this.cssClasses.prefix, this.cssClasses.cursor, !0))
            ...
            function(t, e, n) {
              ...
              function u(t) {
                ...
                ;((t = t || {}).templates = t.templates || {}),
                  ...
                  (this.name = void 0 === t.name || null === t.name ? r.getUniqueId() : t.name),
                  ...
                  (this.cssClasses.prefix =
                    t.cssClasses.formattedPrefix ||
                    r.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix))
                var c = r.className(this.cssClasses.prefix, this.cssClasses.dataset)
                ;(this.$el =
                  ...
                  _render: function(t, e) {
                    if (this.$el) {
                      ...
                      this.$menu &&
                        this.$menu
                          .addClass(
                            this.cssClasses.prefix + (n ? 'with' : 'without') + '-' + this.name
                          )
                          .removeClass(
                            this.cssClasses.prefix + (n ? 'without' : 'with') + '-' + this.name
                          ),
                      ...
                      function l(t) {
                        ...
                        return (
                          (e = i
                            ...
                            .append(o.templates.suggestion.apply(this, [t].concat(a)))).data(
                            'aaDataset',
                            o.name
                          ),
              ...
              var r,
                ...
                a = {
                  ...
                  getSnippetedValue: function(t, e) {
                    if (!t._snippetResult || !t._snippetResult[e] || !t._snippetResult[e].value)
                      return t[e]
