...
***************************************************************************** */
     ...
     */
        ...
        var createPoint = function createPoint(lng, lat) {
        ...
        var addArrow = function addArrow(polyline, length, angleValue, map) {
        ...
        var creatMap = function creatMap(map, config) {
        ...
        var helper_drawPolygon = function drawPolygon(arr) {
          if (arr && arr.length) {
        ...
        var helper_drawPolyline = function drawPolyline(arr) {
          if (arr && arr.length) {
        ...
        var helper_drawCircle = function drawCircle(_ref3) {
          var lng = _ref3.lng,
            lat = _ref3.lat,
            radius = _ref3.radius
          var circle = new BMap.Circle(createPoint(lng, lat), radius, areaConfig)
          return circle
        }
        /**
         * [创建标记marker对象]
        ...
        var helper_createMarker = function createMarker(_ref4) {
          var lng = _ref4.lng,
            lat = _ref4.lat,
          ...
          var myIcon = new BMap.Icon(path, new BMap.Size(35, 55))
          var point = createPoint(lng, lat)
        ...
        var helper_drawPointCollection = function drawPointCollection(arr, opt) {
          if (arr && arr.length) {
            var points = arr.map(function(_ref5) {
              var lng = _ref5.lng,
                lat = _ref5.lat
              return createPoint(lng, lat)
            })
        ...
        var class_BMapClass = /*#__PURE__*/ (function() {
          function BMapClass(options) {
            ...
            this.mapCenter = center // 是否开启绘制模式
          ...
          _createClass(BMapClass, [
            {
              ...
              value: function create() {
                ...
                var poi = createPoint(this.mapCenter[0], this.mapCenter[1])
            ...
            },
            {
              ...
              value: function drawOverlay(arr) {
                ...
                var lng = centerData.lng,
                  lat = centerData.lat
                var centerPoint = createPoint(lng, lat)
                this.map.panTo(centerPoint)
                this.map.enableScrollWheelZoom()

                if (arr.length === 1) {
                  this.currentOverlay = helper_drawCircle(centerData)
                  this.drawingMode = 'circle'
                } else {
                  this.currentOverlay = helper_drawPolygon(arr)
                }
            ...
            },
            {
              ...
              value: function createMarker(opt) {
                ...
                var marker = helper_createMarker(opt)
            ...
            },
            {
              ...
              value: function openInfoPanel(content, e) {
                var point = createPoint(e.point.lng, e.point.lat)
            ...
            },
            {
              ...
              value: function drawPointCollection(arr, opt) {
                var PointCollection = helper_drawPointCollection(arr, opt)
            ...
            },
            {
              ...
              value: function drawCircle(config) {
                this.currentOverlay = helper_drawCircle(config)
                this.map.addOverlay(this.currentOverlay)
              } // 画轨迹线
            },
            {
              ...
              value: function drawPolyline(arr) {
                var polyline = helper_drawPolyline(arr)
            ...
            },
            {
              ...
              value: function drawTrajectory(arr) {
                ...
                for (var j = 0; j < arr.length; j++) {
                  ...
                  var marker = helper_createMarker(markerConfig)
            ...
            },
            {
              ...
              value: function drawLushu(arr) {
                var arrPoints = []
                arr.forEach(function(it) {
                  var point = createPoint(it.lng, it.lat)
        ...
        var GisMapvue_type_script_lang_tsx_VGisMap = /*#__PURE__*/ (function(_Vue) {
          ...
          function VGisMap() {
            ...
            _this.isLushu = false // lushu 数据

            _this.lushuData = [] // 默认实时状态
        ...
        var index_install = function install(vue) {
          ...
          vue.component('VGisMap', packages_GisMap)
        }
