          ...
          _createClass(VTable, [
            ...
            },
            {
              ...
              value: function handleHeaderClick(column, e) {
                ...
                if (currentOrder !== '') {
                  var targetOrder = getTargetSortKey(currentOrder)
            ...
            },
            {
              ...
              value: function clearSortOrderCls(column) {
                ...
                thNode.forEach(function(item) {
                  _this6.removeAllSortOrderCls(item.parentNode.parentNode)
                })
              }
              /**
               * 排序回调
                                ...
                                h('i', {
                                  ...
                                  on: {
                                    click: function click(e) {
                                      return _this7.sortIconClick(e, column, 'ascending')
                                    }
                                  }
                                }),
                                h('i', {
                                  ...
                                  on: {
                                    click: function click(e) {
                                      return _this7.sortIconClick(e, column, 'descending')
                                    }
                                  }
                                })
                              ]
