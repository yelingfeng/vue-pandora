                ...
                var operations = item.operations.map(function(operate, index) {
                  ...
                  if (OperateType.ICON === type) {
                    ...
                    operateDom = h(
                      'div',
                      {
                        class: 'vpandora-table-operate-button'
                      },
                      [
                        h('el-tooltip', helper_default()([{}, tooltipProp]), [
                          h(
                            'el-button',
                            {
                              key: index,
