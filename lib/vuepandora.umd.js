        ...
        var Tablevue_type_script_lang_tsx_VTable = /*#__PURE__*/ (function(_Vue) {
          ...
          _createClass(VTable, [
            ...
            },
            {
              ...
              value: function changeSortOrderClass(node, sourceOrder) {
                var lastOrder = getTargetSortKey(sourceOrder) // 存在则移除上一次的
            ...
            },
            {
              ...
              value: function sortOrderService(column, order) {
                ...
                if (sortModeType.SINGLE === this.option.sortMode) {
                  ...
                  this.option.defaultSort.forEach(function(item) {
                    if (item.prop !== column) {
                      _this5.clearSortOrderCls(item.prop)
                    }
                  })
                }
            ...
            },
            {
              ...
              value: function clearSortOrderCls(column) {
                ...
                thNode.forEach(function(item) {
                  SORT_ARR.forEach(function(order) {
